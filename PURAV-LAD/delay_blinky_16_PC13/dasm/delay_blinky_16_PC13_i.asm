...
__attribute__((naked)) int Reset_Handler(void)  {
 ...
 800000c:	601c      	str	r4, [r3, #0]
    // no need to set LED_PC13 pin to output Mode, 
    ...
    RegToReadWrite = PRPH_ALIAS_ADDR(GPIOD_PUPDR_ADDR, 2 * LED_PC13);
 ...
 8000018:	42470608 	.word	0x42470608
 800001c:	424101e8 	.word	0x424101e8
