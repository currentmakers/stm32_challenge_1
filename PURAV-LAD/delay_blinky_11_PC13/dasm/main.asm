...
00000000 <Reset_Handler>:
  ...
  14:	42470608 	submi	r0, r7, #8, 12	; 0x800000
  18:	42410068 	submi	r0, r1, #104	; 0x68
  1c:	424102b4 	submi	r0, r1, #180, 4	; 0x4000000b
...
00000000 <.debug_info>:
   ...
   c:	000000df 	ldrdeq	r0, [r0], -pc	; <UNPREDICTABLE>
  ...
  5c:	00c60508 	sbceq	r0, r6, r8, lsl #10
  ...
  78:	0000014b 	andeq	r0, r0, fp, asr #2
  ...
  cc:	009a0955 	addseq	r0, sl, r5, asr r9
...
00000000 <.debug_str>:
  ...
  58:	6f5c3a45 	svcvs	0x005c3a45
  5c:	735c7373 	cmpvc	ip, #-872415231	; 0xcc000001
  60:	32336d74 	eorscc	r6, r3, #116, 26	; 0x1d00
  64:	6c726f77 	ldclvs	15, cr6, [r2], #-476	; 0xfffffe24
  68:	6d735f64 	ldclvs	15, cr5, [r3, #-400]!	; 0xfffffe70
  6c:	656c6c61 	strbvs	r6, [ip, #-3169]!	; 0xfffff39f
  70:	625f7473 	subsvs	r7, pc, #1929379840	; 0x73000000
  74:	6b6e696c 	blvs	1b9a62c <Reset_Handler+0x1b9a62c>
  78:	65645c79 	strbvs	r5, [r4, #-3193]!	; 0xfffff387
  7c:	5f79616c 	svcpl	0x0079616c
  80:	6e696c62 	cdpvs	12, 6, cr6, cr9, cr2, {3}
  84:	315f796b 	cmpcc	pc, fp, ror #18
  88:	43505f31 	cmpmi	r0, #49, 30	; 0xc4
  8c:	5f003331 	svcpl	0x00003331
  90:	6e69755f 	mcrvs	5, 3, r7, cr9, cr15, {2}
  94:	5f323374 	svcpl	0x00323374
  98:	6f430074 	svcvs	0x00430074
  9c:	65746e75 	ldrbvs	r6, [r4, #-3701]!	; 0xfffff18b
  a0:	6e750072 	mrcvs	0, 3, r0, cr5, cr2, {3}
  ...
  dc:	4700632e 	strmi	r6, [r0, -lr, lsr #6]
  e0:	4320554e 			; <UNDEFINED> instruction: 0x4320554e
  e4:	31203731 			; <UNDEFINED> instruction: 0x31203731
  e8:	2e332e30 	mrccs	14, 1, r2, cr3, cr0, {1}
  ec:	30322031 	eorscc	r2, r2, r1, lsr r0
  f0:	38303132 	ldmdacc	r0!, {r1, r4, r5, r8, ip, sp}
  f4:	28203432 	stmdacs	r0!, {r1, r4, r5, sl, ip, sp}
 ...
 10c:	346d2d78 	strbtcc	r2, [sp], #-3448	; 0xfffff288
 ...
 134:	2d653776 	stclcs	7, cr3, [r5, #-472]!	; 0xfffffe28
 138:	672d206d 	strvs	r2, [sp, -sp, rrx]!
 13c:	304f2d20 	subcc	r2, pc, r0, lsr #26
 140:	6f687300 	svcvs	0x00687300
 144:	69207472 	stmdbvs	r0!, {r1, r4, r5, r6, sl, ip, sp, lr}
 148:	7500746e 	strvc	r7, [r0, #-1134]	; 0xfffffb92
 14c:	33746e69 	cmncc	r4, #1680	; 0x690
 150:	00745f32 	rsbseq	r5, r4, r2, lsr pc
